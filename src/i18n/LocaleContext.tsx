...
const dict = {
  it: {
    ...
    closed: "Chiuso",
    tryThese: "Abbinalo a…",
    goodMorningPre: "Il gusto giusto, in ",
    goodMorningGold: "ogni",
    goodMorningPost: " momento.",
    bistrotTagline: "Dal primo caffè del mattino all'ultimo brindisi della sera.",
    turin: "Turin",
    open: "Aperto",
  ...
  en: {
    ...
    goodMorningPre: "The right taste, at ",
    goodMorningGold: "every",
    goodMorningPost: " moment.",
    bistrotTagline: "From the first coffee in the morning to the last toast of the evening.",
    turin: "Turin",
    open: "Open",
  ...
  fr: {
    ...
    goodMorningPre: "Le bon goût, à ",
    goodMorningGold: "chaque",
    goodMorningPost: " moment.",
    bistrotTagline: "Du premier café du matin au dernier toast du soir.",
    turin: "Turin",
    open: "Ouvert",
