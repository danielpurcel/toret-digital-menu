...
const dict = {
  it: {
    ...
    closed: "Chiuso",
    tryThese: "Abbinalo a…",
    goodMorning: "Il gusto giusto, in ogni momento.",
  ...
  en: {
    ...
    goodMorning: "The right taste, at every moment.",
  ...
  fr: {
    ...
    goodMorning: "Le bon goût, à chaque moment.",
  ...
  es: {
    ...
    goodMorning: "El sabor justo, en cada momento.",
