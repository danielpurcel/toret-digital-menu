...
const iconMap: Record<string, React.FC<{ size?: number; className?: string }>> = {
  ...
  croissant: ({ size, className }) => (
    <svg
      ...
      className={className}
    >
      <path d="M4 18c0-2 .5-3.5 1.5-5 1-1.5 2.5-2.5 4-3 1.5-.5 2.5-.5 2.5-.5" />
      <path d="M20 18c0-2-.5-3.5-1.5-5-1-1.5-2.5-2.5-4-3-1.5-.5-2.5-.5-2.5-.5" />
      <path d="M8 9.5c0-1.5 1-3 2.5-4 1.5-1 3.5-1.5 5-.5" />
      <path d="M16 9.5c0-1.5-1-3-2.5-4-1.5-1-3.5-1.5-5-.5" />
      <path d="M5 8c-1 1.5-1.5 3-1.5 4.5 0 1.5.5 2.5 1.5 3.5" />
      <path d="M19 8c1 1.5 1.5 3 1.5 4.5 0 1.5-.5 2.5-1.5 3.5" />
      <path d="M4 18c1 1 2 1.5 4 1.5h8c2 0 3-.5 4-1.5" />
      <path d="M7 19.5c0 1 .5 1.5 1.5 1.5h7c1 0 1.5-.5 1.5-1.5" />
