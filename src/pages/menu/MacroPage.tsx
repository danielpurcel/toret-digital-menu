...
const iconMap: Record<string, React.FC<{ size?: number; className?: string }>> = {
  ...
  croissant: ({ size, className }) => (
    <svg
      ...
      className={className}
    >
      <path d="M5 15c0-1.5 1-3 2.5-4 1.2-.8 2.8-1.2 4-1.5l.5-2" />
      <path d="M19 15c0-1.5-1-3-2.5-4-1.2-.8-2.8-1.2-4-1.5l-.5-2" />
      <path d="M7.5 14.5C6.5 15 5.5 16 5 17.5" />
      <path d="M16.5 14.5c1 .5 2 1.5 2.5 3" />
      <path d="M10 10c.5-.8 1.3-1.6 2-2 .7-.4 1.3-.4 2 0 .7.4 1.5 1.2 2 2" />
      <path d="M5 17.5c0 1.5 1 2 2.5 2h9c1.5 0 2.5-.5 2.5-2" />
      <path d="M8 19.5c0 .5.5 1 1.5 1h5c1 0 1.5-.5 1.5-1" />
    </svg>
  ),
};
